...
function createPageContent(container, docSnapshots, i, isAluno) {
      ...
      if (
        ...
        database
          ...
          .then(function (querySnapshot) {
            ...
            for (let i = 0; i < querySnapshot.size; i++) {
              createPageContent(container, docSnapshots, i, false);
            }
          });
      } else {
        userDoc
          ...
          .then(function (querySnapshot) {
            ...
            for (let i = 0; i < querySnapshot.size; i++) {
              ...
              createPageContent(container, docSnapshots, i, true);
            }
          });
      }
    });
